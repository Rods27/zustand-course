...
const menuItems: MenuItem[] = [
  ...
  { title: 'Person', subTitle: 'First and last name', href: '/dashboard/person', Icon: IoAccessibilityOutline },
  { title: 'Tasks', subTitle: 'List of tasks', href: '/dashboard/tasks', Icon: IoListOutline },
  { title: 'Wedding', subTitle: 'Wedding guests', href: '/dashboard/wedding-invitation', Icon: IoHeartOutline },
];
    ...
    <div id="menu" className="bg-gray-900 min-h-screen z-10 text-slate-300 w-80 left-0 overflow-y-scroll">
      ...
      <div id="profile" className="px-6 py-10">
        ...
        <a href="#" className="inline-flex space-x-2 items-center">
          <span>
            <img className="rounded-full w-8 h-8" src="https://avatars.githubusercontent.com/u/67608664?v=4" alt="" />
          </span>
